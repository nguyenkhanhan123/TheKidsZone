...
import com.gh.mp3player.thekidszone.viewmodel.PlayScreenModel2


class PlayScreenCrazyMath2 : BaseFragment<PlayScreenCrazyMathBinding, PlayScreenModel2>() {

    override fun getClassVM(): Class<PlayScreenModel2> {
        return PlayScreenModel2::class.java
    }
    ...
    override fun initView() {
        ...
        val bestScore = CommonUtils.getInstance().getPref("BEST2")
        if (bestScore != null) {
    ...
    private fun gameOver() {
        ...
        if (score > best) {
            ...
            CommonUtils.getInstance().savePref("BEST2", score.toString())
        }
    ...
    companion object {
        val TAG: String = PlayScreenCrazyMath2::class.java.name
    }
